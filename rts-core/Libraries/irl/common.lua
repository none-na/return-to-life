...
-- Capped, Won't be able to work well
-- removal("Paul's Goat Hoof", function(player)
	-- pHmax = min ( pHmax + 0.15 , 5 ) -- Base 1.3
-- end)
...
-- Capped, won't be able to work well
-- removal("Soldier's Syringe", function(player)
	-- attack_speed = max ( attack_speed , min ( attack_speed + 0.12 , 2.8 ) ) -- Base 1
-- end)
